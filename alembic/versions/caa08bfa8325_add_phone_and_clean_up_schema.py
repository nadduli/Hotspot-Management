...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "users", sa.Column("role_id", sa.UUID(), autoincrement=False, nullable=False)
    )
    op.create_foreign_key(
        op.f("users_role_id_fkey"), "users", "roles", ["role_id"], ["id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
            name=op.f("branches_organization_id_fkey"),
        ),
